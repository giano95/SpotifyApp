...
public class FindArtistNameEasyUI extends AbstractActivityUI {
    ...
    public void update() {
        ...
        ((Button)mViews.get(a)).setText(mySpotify.getCurrentTrackArtist());
        ((Button)mViews.get(b)).setText(mySpotify.getNextTrackArtist());
        ((Button)mViews.get(c)).setText(mySpotify.getPrevTrackArtist());
